...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += HelpMessageOpt("-fast-ibd=<0|1>", _("Skip proof-of-work checks for network IBD blocks committed to by the last hard-coded checkpoint; unknown chains and forks still verify PoW. Set to 0 for full IBD PoW validation (default: 1)"));
    ...
    strUsage += HelpMessageOpt("-prunedebuglogfile", _("Prune (limit) filesize of debug.log (default: enabled)")); // FIXME.SUGAR // prune debug.log
    strUsage += HelpMessageOpt("-noprunedebuglogfile", _("Disable pruning of debug.log")); // FIXME.SUGAR // prune debug.log
    if (showDebug)
    {
...
void InitLogging()
{
    ...
    fPruneDebugLog = gArgs.GetBoolArg("-prunedebuglogfile", true) && !gArgs.GetBoolArg("-noprunedebuglogfile", false); // FIXME.SUGAR // prune debug.log
